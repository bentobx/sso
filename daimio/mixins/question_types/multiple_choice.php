...
/**
 * A multiple choice question n' stuff
 *
 * @package bonsai
 * @author dann toliver
 * @version 2.0
...
class Question_typesMultiple_choice
{
  ...
  */ 
  static function add_answer($test, $pq, $question, $answer)
  {
    ...
    // (also prevents 'false' answers from leaking through)
    $input = (int) $input;
